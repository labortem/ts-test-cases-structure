import { IsClassGetterLike, IsClassMethodLike } from "@tests/types/structure/isLike";
import { Class, Getter, TestCaseExtras } from "@tests/types/signatures";
import {
	CanTestCaseThrow,
...
export type TestCaseOfClassGetter<C extends Class, G extends Getter, E extends TestCaseExtras | void = void> =
	E extends void ?
		...
		: IsClassGetterLike<C, G, false, true> extends true ? [G]
		: IsClassGetterLike<C, G, true, false> extends true ? [ConstructorParameters<C>]
		: IsClassGetterLike<C, G, true, true> extends true ? [ConstructorParameters<C>, G]
		: never
	: CanTestCaseThrow<E> extends true ?
		...
		:	never
	: IsClassGetterLike<C, G, false, false> extends true ? [E]
	: IsClassGetterLike<C, G, false, true> extends true ? [G, E]
	: IsClassGetterLike<C, G, true, false> extends true ? [ConstructorParameters<C>, E]
	: IsClassGetterLike<C, G, true, true> extends true ? [ConstructorParameters<C>, G, E]
	: never;
